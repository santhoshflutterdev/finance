...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    ...
    try {
      await FirebaseAuth.instance.signInWithEmailAndPassword(email: _emailCtrl.text.trim(), password: _passwordCtrl.text);
      if (!mounted) return;
              ...
              child: Form(
                ...
                child: Column(mainAxisSize: MainAxisSize.min, children: [
                  ...
                  TextFormField(
                    ...
                    decoration: AppTheme.inputDecoration(label: 'Email', hint: 'you@example.com'),
                  ...
                  OutlinedButton(onPressed: () => Navigator.pushNamed(context, '/signup'), child: const Text('Create an account')),
                ]),
              ),
            ),
          ),
