...
class DashboardPage extends StatelessWidget {
  ...
  final List<_DummyTxn> _txns = const [
    ...
    _DummyTxn(title: 'Salary', subtitle: 'Company Inc • 2 days ago', amount: 2500.00),
    _DummyTxn(title: 'Coffee', subtitle: 'Cafe Latte • Yesterday', amount: -3.50),
    _DummyTxn(title: 'Freelance', subtitle: 'Design work • 5 days ago', amount: 120.00),
  ];
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text('\$${29000.45.toStringAsFixed(2)}', style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
                        ]),
                      ),
                      Column(children: [
                        ElevatedButton(onPressed: () {}, child: const Text('SEND')),
                        const SizedBox(height: 8),
                        OutlinedButton(onPressed: () {}, child: const Text('REQUEST')),
                      ])
                    ],
                  ),
                ),
